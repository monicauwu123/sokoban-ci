...
def heuristic_manhattan(posPlayer, posBox):
    ...
    for i in range(len(remainBox)):
        ...
        distance += abs(remainBox[i][0] - remainGoal[i][0]) + abs(remainBox[i][1] - remainGoal[i][1])
...
def heuristic_euclidean(posPlayer, posBox):
    ...
    for i in range(len(remainBox)):
        distance += math.sqrt((remainBox[i][0] - remainGoal[i][0])**2 + (remainBox[i][1] - remainGoal[i][1])**2)
